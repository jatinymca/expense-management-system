...
{
$userid=$_SESSION['detsuid1'];
$cpassword=md5($_POST['currentpassword']);
$newpassword=md5($_POST['newpassword']);
$query=mysqli_query($con,"select ID from tlbadmin where ID='$userid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tlbadmin set Password='$newpassword'  ");
...
<body>
    ...
    echo $msg;
						...
						<div class="col-md-12">
							 <?php
$userid=$_SESSION['detsuid1'];
$ret=mysqli_query($con,"select * from tlbadmin  ");
$cnt=1;
