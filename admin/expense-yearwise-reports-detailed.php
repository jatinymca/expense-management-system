...
// $userid=$_SESSION['userid'];
 if($userid==0){
						 $select="SELECT ExpenseDate,ExpenseItem,ExpenseCost,Quantity FROM `tblexpense` where (ExpenseDate BETWEEN '$fdate' and '$tdate') ";}
								...
								$select="SELECT ExpenseItem,ExpenseCost,ExpenseDate,Quantity,year(ExpenseDate) as rptyear FROM tblexpense  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') ";}
