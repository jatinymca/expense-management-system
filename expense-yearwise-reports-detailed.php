			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
							<a id="year" href="checky.php" >	<button type="submit"  class="btn btn-primary" style="float: right;" name="export">export</button></a>
						<div class="col-md-12">
...
$_SESSION['fyear']=$fdate;
$_SESSION['tyear']=$tdate;
?>
...
$ret=mysqli_query($con,"SELECT ExpenseItem,ExpenseCost,ExpenseDate,Quantity,year(ExpenseDate) as rptyear FROM tblexpense  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') ");
$cnt=1;
