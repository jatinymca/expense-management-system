						...
						<div class="col-md-12">
							...
							<table   class="table table-bordered dt-responsive nowrap" id="exaample" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								<thead>
									...
									$select="SELECT ExpenseItem,ExpenseCost,ExpenseDate,Quantity,Opening_balance,Closing_balance, month(ExpenseDate) as rptmonth,year(ExpenseDate) as rptyear FROM tblexpense  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') ";
