...
if (strlen($_SESSION['detsuid']==0)) {
  header('location:logout.php');
              ...
              $userid=$_SESSION['detsuid'];
                              ...
                              $query=mysqli_query($con,"SELECT ExpenseDate,ExpenseCost,ExpenseItem,Quantity,year(ExpenseDate) as rptyear FROM tblexpense  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid')  ORDER BY ExpenseDate,rptyear ASC");
                                      $Total_Cost=0;                  
